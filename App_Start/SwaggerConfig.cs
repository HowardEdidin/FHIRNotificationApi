                ...
                .EnableSwagger(c =>
                    {
                        ...
                        //
                        c.SingleApiVersion("v1", "FhirNotificationApi")
                            .Description(
                                "Change Feed suppport provides a sorted list of FHIR documents (Resources) within a DocumentDB collection in the order of which they were modifed \r\n" +
                                "Changes in DocumentDB are persisted and can be processed asynchronously, and distributed across one or more consumers for parallel processing \r\n\r\n " +
